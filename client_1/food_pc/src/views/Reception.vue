      ...
      <el-container>
        ...
        >
          <el-table
            ...
            :data="tableData"
            border
            style="width: 98%;margin: 20px auto;max-height:640px;overflow-y:auto"
          >
            ...
            <el-table-column width="120" label="操作" prop="discount">
              <template>
                <el-button type="text" size="mini">加菜</el-button>
                <el-button type="text" size="mini">点菜</el-button>
              </template>
            </el-table-column>
          </el-table>
          <div class="pool">
...
.s_suo > span{color: #181818;font-size: 25px;}
.pool {
  width: 96%;
