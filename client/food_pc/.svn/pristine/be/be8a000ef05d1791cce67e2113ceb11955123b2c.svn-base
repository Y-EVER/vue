...
import Staff from '@/views/staff/Staff'//系统设置
...
const routes = [
  ...
  },
  {
    ...
    component: Staff,
    children:[ 
      {path: '/staff/staff_manage', name: 'staff_manage', component: () => import('../views/staff/Staff_manage.vue')},//员工管理
      {path: '/staff/add_staff', name: 'add_staff', component: () => import('../views/staff/Add_staff.vue')},//添加员工
      {path: '/staff/wages', name: 'wages', component: () => import('../views/staff/Wages.vue')},//工资管理
      {path: '/staff/leave', name: 'leave', component: () => import('../views/staff/Leave.vue')},//请假奖惩
    ]
  },
  {
    path:'/console',//控制台
